  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        ogTitle: `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        twitterTitle: `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
