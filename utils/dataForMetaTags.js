...
export const dataForMetaTags = {
  ...
  naprawa_suszarek: {
    metaTags: {
      title: `Naprawa Suszarek Przemyśl ☎️ 790 258 612 | ${shortName}`,
      ogTitle: `Naprawa Suszarek Przemyśl ☎️ 790 258 612 | ${shortName}`,
      twitterTitle: `Naprawa Suszarek Przemyśl ☎️ 790 258 612 | ${shortName}`,
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `Naprawa Suszarek Przemyśl ☎️ 790 258 612 | ${shortName}`,
