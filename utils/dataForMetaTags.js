  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `${shortName} ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        ogTitle: `${shortName} ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        twitterTitle: `${shortName} ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `${shortName} ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
    ...
    kontakt: {
      metaTags: {
        title: `Kontakt ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.kontakt,
          "inLanguage": "pl-PL",
          "name": `Kontakt ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
          "isPartOf": { "@type": "WebSite", "@id": appUrls.home + "#website" },
          "datePublished": datePublished,
          "dateModified": dateModified,
    ...
    naprawa_pralek: {
      metaTags: {
        title: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        ogTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        twitterTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        ogTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        twitterTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
    ...
    naprawa_zmywarek: {
      metaTags: {
        title: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        ogTitle: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        twitterTitle: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": "520",
          "height": "520",
          "name": `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
    ...
    naprawa_ekspresow: {
      metaTags: {
        title: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        ogTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        twitterTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
    ...
    naprawa_telewizorow: {
      metaTags: {
        title: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        ogTitle: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
        twitterTitle: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | SerwisRTVAGD`,
