...
export const getDataForMetaTags = async (key) => {
  ...
  const dataForMetaTags = {
    ...
    kontakt: {
      metaTags: {
        title: `Kontakt ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.kontakt,
          "inLanguage": "pl-PL",
          "name": `Kontakt ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
          "isPartOf": { "@type": "WebSite", "@id": appUrls.home + "#website" },
          "datePublished": datePublished,
          "dateModified": dateModified,
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
        ogTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
        twitterTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
