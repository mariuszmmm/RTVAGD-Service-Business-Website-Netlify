  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `${name} ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
        ogTitle: `${name} ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
        twitterTitle: `${name} ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `${name} ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
