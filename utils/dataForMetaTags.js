  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `🔧 Naprawa RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
        ogTitle: `🔧 Naprawa RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
        twitterTitle: `🔧 Naprawa RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `🔧 Naprawa RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
