  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `${name} ☎️ ${formattedPhoneNumber}`,
        ogTitle: `${name} ☎️ ${formattedPhoneNumber}`,
        twitterTitle: `${name} ☎️ ${formattedPhoneNumber}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `${name} ☎️ ${formattedPhoneNumber}`,
    ...
    naprawa_pralek: {
      metaTags: {
        title: `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
