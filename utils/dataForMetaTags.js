  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Naprawa RTV i AGD ☎️ ${shortPhoneNumber} | ${name}`,
        ogTitle: `Naprawa RTV i AGD ☎️ ${shortPhoneNumber} | ${name}`,
        twitterTitle: `Naprawa RTV i AGD ☎️ ${shortPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Naprawa RTV i AGD ☎️ ${shortPhoneNumber} | ${name}`,
