...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      title: `Naprawa sprzętu RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ogTitle: `Naprawa sprzętu RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      twitterTitle: `Naprawa sprzętu RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
    ...
    schema: {
      ...
      webpage: {
        ...
        "url": appUrls.home,
        "inLanguage": "pl-PL",
        "name": `Naprawa sprzętu RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
