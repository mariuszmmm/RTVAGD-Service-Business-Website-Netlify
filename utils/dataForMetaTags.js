...
export const getDataForMetaTags = async (key) => {
  ...
  const dataForMetaTags = {
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Naprawa Przemyśl`,
        ogTitle: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Naprawa Przemyśl`,
        twitterTitle: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Naprawa Przemyśl`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Naprawa Przemyśl`,
