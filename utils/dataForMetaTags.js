  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Naprawa RTV i AGD Przemyśl | ${shortName}`,
        ogTitle: `Naprawa RTV i AGD Przemyśl | ${shortName}`,
        twitterTitle: `Naprawa RTV i AGD Przemyśl | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Naprawa RTV i AGD Przemyśl | ${shortName}`,
