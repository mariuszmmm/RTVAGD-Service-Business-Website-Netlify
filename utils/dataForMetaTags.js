  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `${shortName} Przemyśl ☎️ ${formattedPhoneNumber}`,
        ogTitle: `${shortName} Przemyśl ☎️ ${formattedPhoneNumber}`,
        twitterTitle: `${shortName} Przemyśl ☎️ ${formattedPhoneNumber}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `${shortName} Przemyśl ☎️ ${formattedPhoneNumber}`,
