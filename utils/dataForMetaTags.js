  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Naprawa ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        ogTitle: `Naprawa ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        twitterTitle: `Naprawa ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Naprawa ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
