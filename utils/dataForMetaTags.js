  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `🔧 Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
        ogTitle: `🔧 Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
        twitterTitle: `🔧 Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `🔧 Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
