...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      title: `${shortName} Przemyśl 🔧 Naprawa ☎️ ${shortPhoneNmuber}`,
      ogTitle: `${shortName} Przemyśl 🔧 Naprawa ☎️ ${shortPhoneNmuber}`,
      twitterTitle: `${shortName} Przemyśl 🔧 Naprawa ☎️ ${shortPhoneNmuber}`,
    ...
    schema: {
      ...
      webpage: {
        ...
        "url": appUrls.home,
        "inLanguage": "pl-PL",
        "name": `${shortName} Przemyśl 🔧 Naprawa ☎️ ${shortPhoneNmuber}`,
  ...
  naprawa_pralek: {
    metaTags: {
      title: `${shortName} Przemyśl ✔️ Naprawa Pralek ☎️ ${shortPhoneNmuber}`,
      ogTitle: `${shortName} Przemyśl ✔️ Naprawa Pralek ☎️ ${shortPhoneNmuber}`,
      twitterTitle: `${shortName} Przemyśl ✔️ Naprawa Pralek ☎️ ${shortPhoneNmuber}`,
      description: `Serwis i naprawa pralek w Przemyślu. Awaria pralki❓ Szybka i skuteczna naprawa z gwarancją w konkurencyjnych cenach. Zadzwoń! ☎️${shortPhoneNmuber}`,
      ogDescription: `Serwis i naprawa pralek w Przemyślu. Awaria pralki❓ Szybka i skuteczna naprawa z gwarancją w konkurencyjnych cenach.`,
      twitterDescription: `Serwis i naprawa pralek w Przemyślu. Awaria pralki❓ Szybka i skuteczna naprawa z gwarancją w konkurencyjnych cenach.`,
      imageType: "image/webp",
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `${shortName} Przemyśl ✔️ Naprawa Pralek ☎️ ${shortPhoneNmuber}`,
  ...
  naprawa_suszarek: {
    metaTags: {
      title: `${shortName} Przemyśl ✔️ Naprawa Suszarek ☎️ ${shortPhoneNmuber}`,
      ogTitle: `${shortName} Przemyśl ✔️ Naprawa Suszarek ☎️ ${shortPhoneNmuber}`,
      twitterTitle: `${shortName} Przemyśl ✔️ Naprawa Suszarek ☎️ ${shortPhoneNmuber}`,
      description: `Serwis i naprawa suszarek do ubrań w Przemyślu. Potrzebujesz naprawić suszarkę❓ Profesjonalny serwis suszarek z dojazdem. 📞Zadzwoń! 📞${shortPhoneNmuber}`,
      ogDescription: "Serwis i naprawa suszarek do ubrań w Przemyślu. Potrzebujesz naprawić suszarkę❓ Profesjonalny serwis suszarek z dojazdem.",
      twitterDescription: "Serwis i naprawa suszarek do ubrań w Przemyślu. Potrzebujesz naprawić suszarkę❓ Profesjonalny serwis suszarek z dojazdem.",
      imageType: "image/webp",
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `${shortName} Przemyśl ✔️ Naprawa Suszarek ☎️ ${shortPhoneNmuber}`,
  ...
  naprawa_zmywarek: {
    metaTags: {
      title: `${shortName} Przemyśl ✔️ Naprawa Zmywarek ☎️ ${shortPhoneNmuber}`,
      ogTitle: `${shortName} Przemyśl ✔️ Naprawa Zmywarek ☎️ ${shortPhoneNmuber}`,
      twitterTitle: `${shortName} Przemyśl ✔️ Naprawa Zmywarek ☎️ ${shortPhoneNmuber}`,
      description: `Serwis i naprawa zmywarek w Przemyślu. Awaria zmywarki❓ Skuteczne usuwanie usterek z gwarancją i dojazdem. Fachowa pomoc. Zadzwoń! ☎️ ${shortPhoneNmuber}`,
      ogDescription: "Serwis i naprawa zmywarek w Przemyślu. Awaria zmywarki❓ Skuteczne usuwanie usterek z gwarancją i dojazdem. Fachowa pomoc.",
      twitterDescription: "Serwis i naprawa zmywarek w Przemyślu. Awaria zmywarki❓ Skuteczne usuwanie usterek z gwarancją i dojazdem. Fachowa pomoc.",
      imageType: "image/webp",
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `${shortName} Przemyśl ✔️ Naprawa Zmywarek ☎️ ${shortPhoneNmuber}`,
  ...
  naprawa_ekspresow: {
    metaTags: {
      title: `${shortName} Przemyśl ✔️ Naprawa Ekspresów ☎️ ${shortPhoneNmuber}`,
      ogTitle: `${shortName} Przemyśl ✔️ Naprawa Ekspresów ☎️ ${shortPhoneNmuber}`,
      twitterTitle: `${shortName} Przemyśl ✔️ Naprawa Ekspresów ☎️ ${shortPhoneNmuber}`,
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `${shortName} Przemyśl ✔️ Naprawa Ekspresów ☎️ ${shortPhoneNmuber}`,
  ...
  naprawa_telewizorow: {
    metaTags: {
      title: `${shortName} Przemyśl ✔️ Naprawa Telewizorów`,
      ogTitle: `${shortName} Przemyśl ✔️ Naprawa Telewizorów`,
      twitterTitle: `${shortName} Przemyśl ✔️ Naprawa Telewizorów`,
      description: `Naprawa telewizorów LED, LCD, OLED w Przemyślu. Twój TV nie działa❓ Profesjonalny serwis RTV z gwarancją i dojazdem. Zadzwoń! ☎️ ${shortPhoneNmuber}`,
      ogDescription: `Naprawa telewizorów LED, LCD, OLED w Przemyślu. Twój TV nie działa❓ Profesjonalny serwis RTV z gwarancją i dojazdem. Zadzwoń! ☎️ ${shortPhoneNmuber}`,
      twitterDescription: `Naprawa telewizorów LED, LCD, OLED w Przemyślu. Twój TV nie działa❓ Profesjonalny serwis RTV z gwarancją i dojazdem. Zadzwoń! ☎️ ${shortPhoneNmuber}`,
      imageType: "image/webp",
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `${shortName} Przemyśl ✔️ Naprawa Telewizorów`,
