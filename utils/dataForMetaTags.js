...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      title: `Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ogTitle: `Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      twitterTitle: `Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
   ...
   //        "priceCurrency": "PLN",
    ...
    //     },
      ...
      webpage: {
        ...
        "url": appUrls.home,
        "inLanguage": "pl-PL",
        "name": `Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
