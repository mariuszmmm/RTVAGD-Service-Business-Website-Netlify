  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
        ogTitle: `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
        twitterTitle: `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis RTV-AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
    ...
    naprawa_pralek: {
      metaTags: {
        title: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
        ogTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
        twitterTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
