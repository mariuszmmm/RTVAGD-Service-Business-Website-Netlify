  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
    ...
    kontakt: {
      metaTags: {
        title: `Kontakt ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.kontakt,
          "inLanguage": "pl-PL",
          "name": `Kontakt ☎️ ${formattedPhoneNumber} | ${name}`,
          "isPartOf": { "@type": "WebSite", "@id": appUrls.home + "#website" },
          "datePublished": datePublished,
          "dateModified": dateModified,
    ...
    naprawa_pralek: {
      metaTags: {
        title: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${name}`,
    ...
    naprawa_zmywarek: {
      metaTags: {
        title: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": "520",
          "height": "520",
          "name": `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
    ...
    naprawa_ekspresow: {
      metaTags: {
        title: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
    ...
    naprawa_telewizorow: {
      metaTags: {
        title: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
