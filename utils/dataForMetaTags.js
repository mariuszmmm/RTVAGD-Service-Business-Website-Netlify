  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        ogTitle: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        twitterTitle: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
