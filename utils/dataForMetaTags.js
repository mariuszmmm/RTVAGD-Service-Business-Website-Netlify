  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        ogTitle: `✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        twitterTitle: `✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Serwis RTV-AGD`,
        ogTitle: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Serwis RTV-AGD`,
        twitterTitle: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Serwis RTV-AGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | Serwis RTV-AGD`,
