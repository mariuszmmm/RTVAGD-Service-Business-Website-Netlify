  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV i AGD Przemyśl | ${shortName}`,
        ogTitle: `Serwis RTV i AGD Przemyśl | ${shortName}`,
        twitterTitle: `Serwis RTV i AGD Przemyśl | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis RTV i AGD Przemyśl | ${shortName}`,
