...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      title: `${shortName} ✔️ Przemyśl ☎️ ${formattedPhoneNumber}`,
      ogTitle: `${shortName} ✔️ Przemyśl ☎️ ${formattedPhoneNumber}`,
      twitterTitle: `${shortName} ✔️ Przemyśl ☎️ ${formattedPhoneNumber}`,
   ...
   //        "priceCurrency": "PLN",
    ...
    //     },
      ...
      webpage: {
        ...
        "url": appUrls.home,
        "inLanguage": "pl-PL",
        "name": `${shortName} ✔️ Przemyśl ☎️ ${formattedPhoneNumber}`,
