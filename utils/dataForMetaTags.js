  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
        ogTitle: `Serwis RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
        twitterTitle: `Serwis RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD w Przemyślu`,
