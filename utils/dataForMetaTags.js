...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      title: `Naprawa Przemyśl 📞 ${formattedPhoneNumber} | ${shortName}`,
      ogTitle: `Naprawa Przemyśl 📞 ${formattedPhoneNumber} | ${shortName}`,
      twitterTitle: `Naprawa Przemyśl 📞 ${formattedPhoneNumber} | ${shortName}`,
      description: `Profesjonalny Serwis RTV i AGD w Przemyślu. Naprawia: ✔️pralki, ✔️suszarki, ✔️zmywarki, ✔️telewizory, ✔️ekspresy do kawy. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      ogDescription: `Profesjonalny Serwis RTV i AGD w Przemyślu. Naprawia: ✔️pralki, ✔️suszarki, ✔️zmywarki, ✔️telewizory, ✔️ekspresy do kawy. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      twitterDescription: `Profesjonalny Serwis RTV i AGD w Przemyślu. Naprawia: ✔️pralki, ✔️suszarki, ✔️zmywarki, ✔️telewizory, ✔️ekspresy do kawy. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
    ...
    schema: {
      ...
      webpage: {
        ...
        "url": appUrls.home,
        "inLanguage": "pl-PL",
        "name": `Naprawa Przemyśl 📞 ${formattedPhoneNumber} | ${shortName}`,
  ...
  kontakt: {
    metaTags: {
      title: `Kontakt ✔️ ${shortName} w Przemyślu ☎️ ${shortPhoneNmuber} | ${shortName}`,
    ...
    schema: {
      ...
      webpage: {
        ...
        "url": appUrls.kontakt,
        "inLanguage": "pl-PL",
        "name": `Kontakt ✔️ ${shortName} w Przemyślu ☎️ ${shortPhoneNmuber} | ${shortName}`,
        "isPartOf": { "@type": "WebSite", "@id": appUrls.home + "#website" },
        "datePublished": datePublished,
        "dateModified": dateModified,
        "description": `Skontaktuj się pod numerem ${serwis.phone.formatted} lub odwiedź nas w Przemyślu, ul. Generała Sowińskiego 2. Szybkie, fachowe usługi naprawy sprzętu RTV i AGD.`,
  ...
  o_mnie: {
    metaTags: {
      title: `Informacje o mnie ✔️ ${shortName} w Przemyślu | ${shortName}`,
  ...
  opinie: {
    path: "/opinie/",
    metaTags: {
      title: `Poznaj opinie klientów ✔️ ${shortName} w Przemyślu | ${shortName}`,
  ...
  naprawa_pralek: {
    metaTags: {
      title: `Naprawa Pralek Przemyśl 🧺 Serwis AGD | ${shortName}`,
      ogTitle: `Naprawa Pralek Przemyśl 🧺 Serwis AGD | ${shortName}`,
      twitterTitle: `Naprawa Pralek Przemyśl 🧺 Serwis AGD | ${shortName}`,
      description: `Serwis i naprawa pralek w Przemyślu. Awaria pralki❓ Szybka i skuteczna naprawa z gwarancją w konkurencyjnych cenach. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      ogDescription: `Serwis i naprawa pralek w Przemyślu. Awaria pralki❓ Szybka i skuteczna naprawa z gwarancją w konkurencyjnych cenach. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      twitterDescription: `Serwis i naprawa pralek w Przemyślu. Awaria pralki❓ Szybka i skuteczna naprawa z gwarancją w konkurencyjnych cenach. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      imageType: "image/webp",
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `Naprawa Pralek Przemyśl 🧺 Serwis AGD | ${shortName}`,
  ...
  naprawa_suszarek: {
    metaTags: {
      title: `Naprawa Suszarek Przemyśl 🌀 Serwis AGD | ${shortName}`,
      ogTitle: `Naprawa Suszarek Przemyśl 🌀 Serwis AGD | ${shortName}`,
      twitterTitle: `Naprawa Suszarek Przemyśl 🌀 Serwis AGD | ${shortName}`,
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `Naprawa Suszarek Przemyśl 🌀 Serwis AGD | ${shortName}`,
  ...
  naprawa_zmywarek: {
    metaTags: {
      ...
      ogTitle: `Naprawa Zmywarek Przemyśl 🔧 Serwis | ${shortName}`,
      twitterTitle: `Naprawa Zmywarek Przemyśl 🔧 Serwis | ${shortName}`,
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `Naprawa Zmywarek Przemyśl 🔧 Serwis | ${shortName}`,
  ...
  naprawa_ekspresow: {
    metaTags: {
      title: `Naprawa Ekspresów do kawy ☕ Przemyśl | Serwis RTV i AGD`,
      ogTitle: `Naprawa Ekspresów do kawy ☕ Przemyśl | Serwis RTV i AGD`,
      twitterTitle: `Naprawa Ekspresów do kawy ☕ Przemyśl | Serwis RTV i AGD`,
      description: `Serwis i naprawa ekspresów do kawy w Przemyślu ☕ Przywróć doskonały smak kawy ✨ Serwis ekspresu ciśnieniowego i automatycznego. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      ogDescription: `Serwis i naprawa ekspresów do kawy w Przemyślu ☕ Przywróć doskonały smak kawy ✨ Serwis ekspresu ciśnieniowego i automatycznego. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      twitterDescription: `Serwis i naprawa ekspresów do kawy w Przemyślu ☕ Przywróć doskonały smak kawy ✨ Serwis ekspresu ciśnieniowego i automatycznego. 📞 Zadzwoń! 📱 ${shortPhoneNmuber}`,
      imageType: "image/webp",
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `Naprawa Ekspresów do kawy ☕ Przemyśl  | Serwis RTV i AGD`,
  ...
  naprawa_telewizorow: {
    metaTags: {
      title: `Naprawa Telewizorów Przemyśl 📺 | ${shortName}`,
      ogTitle: `Naprawa Telewizorów Przemyśl 📺 | ${shortName}`,
      twitterTitle: `Naprawa Telewizorów Przemyśl 📺 | ${shortName}`,
      description: `Naprawa telewizorów LED, LCD, OLED w Przemyślu. Twój TV nie działa❓ Profesjonalny serwis RTV z gwarancją i dojazdem. ☎️ Zadzwoń! 📱 ${shortPhoneNmuber}`,
      ogDescription: `Naprawa telewizorów LED, LCD, OLED w Przemyślu. Twój TV nie działa❓ Profesjonalny serwis RTV z gwarancją i dojazdem. ☎️ Zadzwoń! 📱 ${shortPhoneNmuber}`,
      twitterDescription: `Naprawa telewizorów LED, LCD, OLED w Przemyślu. Twój TV nie działa❓ Profesjonalny serwis RTV z gwarancją i dojazdem. ☎️ Zadzwoń! 📱 ${shortPhoneNmuber}`,
      imageType: "image/webp",
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `Naprawa Telewizorów Przemyśl 📺 | ${shortName} | ${shortName}`,
