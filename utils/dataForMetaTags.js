  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        ogTitle: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        twitterTitle: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
