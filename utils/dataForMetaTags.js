  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
        ogTitle: `Serwis RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
        twitterTitle: `Serwis RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | Naprawa Przemyśl`,
