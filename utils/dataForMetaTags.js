  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        ogTitle: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
        twitterTitle: `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${name}`,
