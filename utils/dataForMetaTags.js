  ...
  home: {
    ...
    schema: {
      ...
      webpage: {
        ...
        "primaryImage": { "@id": appUrls.home + "#primaryimage" },
  ...
  naprawa_pralek: {
    ...
    schema: {
      ...
      webpage: {
        ...
        "primaryImage": { "@id": appUrls.naprawa_pralek + "#primaryimage" },
    ...
    schema: {
      ...
      product: {
        ...
        "offers": {
          ...
          "seller": { "@id": appUrls.home + "#organization", "name": "Serwis_RTV-AGD" },
      ...
      imageObject: {
        ...
        "name": "Naprawa suszarek Przemyśl",
        "description": "Technik serwisu AGD naprawia awarię suszarki do ubrań",

        "author": { "@type": "Organization", "name": "Naprawa sprzętu RTV i AGD Serwis_RTV-AGD" },
        "contentLocation": { "@type": "Place", "name": "Przemyśl" },
      ...
      webpage: {
        ...
        "primaryImage": { "@id": appUrls.naprawa_suszarek + "#primaryimage" },
  ...
  naprawa_zmywarek: {
    ...
    schema: {
      ...
      webpage: {
        ...
        "primaryImage": { "@id": appUrls.naprawa_zmywarek + "#primaryimage" },
  ...
  naprawa_ekspresow: {
    ...
    schema: {
      ...
      webpage: {
        ...
        "primaryImage": { "@id": appUrls.naprawa_ekspresow + "#primaryimage" },
  ...
  naprawa_telewizorow: {
    ...
    schema: {
      ...
      webpage: {
        ...
        "primaryImage": { "@id": appUrls.naprawa_telewizorow + "#primaryimage" },
