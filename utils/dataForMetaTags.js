  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Naprawa RTV i AGD ✔️ Serwis Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
        ogTitle: `Naprawa RTV i AGD ✔️ Serwis Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
        twitterTitle: `Naprawa RTV i AGD ✔️ Serwis Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Naprawa RTV i AGD ✔️ Serwis Przemyśl ☎️ ${formattedPhoneNumber} | NaprawaPrzemysl`,
    ...
    naprawa_zmywarek: {
      ...
      schema: {
        ...
        imageObject: {
          ...
          "url": imageParameters.naprawa_zmywarek.imageUrl_520,
          "inLanguage": "pl-PL",
