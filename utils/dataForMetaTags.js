...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      title: `Naprawa RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ogTitle: `Naprawa RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
      twitterTitle: `Naprawa RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
   ...
   //        "priceCurrency": "PLN",
    ...
    //     },
      ...
      webpage: {
        ...
        "url": appUrls.home,
        "inLanguage": "pl-PL",
        "name": `Naprawa RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
