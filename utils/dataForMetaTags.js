...
export const dataForMetaTags = {
  home: {
    metaTags: {
      title: "Naprawa RTV i AGD w Przemyślu | " + serwis.shortName + " ☎️ 790 258 612",
      ...
      appleMobileWebAppTitle: "Naprawa RTV i AGD w Przemyślu | " + serwis.shortName + " ☎️ 790 258 612",
    },
    schema: {
      localBusiness,
      organization: {
      ...
      webpage: {
        ...
        "url": appUrls.home,
        "inLanguage": "pl-PL",
        "name": "Naprawa RTV i AGD w Przemyślu | " + serwis.shortName + " ☎️ 790 258 612",
      ...
      imageObject: {
        ...
        "width": 931,
        "height": 497,
        "caption": "Naprawa RTV i AGD w Przemyślu | " + serwis.shortName + " ☎️ 790 258 612",
      },
      breadcrumbList: {
        "@type": "BreadcrumbList",
        "@id": appUrls.home + "#breadcrumb",
