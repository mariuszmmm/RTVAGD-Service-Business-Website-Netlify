...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      description: `Profesjonalny Serwis RTV i AGD w Przemyślu. Naprawa: ✔️ Pralki ✔️ Suszarki do prania ✔️ Zmywarki ✔️ Telewizory ✔️ Ekspresy do kawy ⚡ Zadzwoń! ☎️ ${formattedPhoneNumber}`,
      ogDescription: `Profesjonalny Serwis RTV i AGD w Przemyślu. Naprawa: ✔️ Pralki ✔️ Suszarki do prania ✔️ Zmywarki ✔️ Telewizory ✔️ Ekspresy do kawy ⚡ Zadzwoń! ☎️ ${formattedPhoneNumber}`,
      twitterDescription: `Profesjonalny Serwis RTV i AGD w Przemyślu. Naprawa: ✔️ Pralki ✔️ Suszarki do prania ✔️ Zmywarki ✔️ Telewizory ✔️ Ekspresy do kawy ⚡ Zadzwoń! ☎️ ${formattedPhoneNumber}`,
  ...
  naprawa_suszarek: {
    metaTags: {
      title: `Naprawa Suszarek Przemyśl ☎️ 790 258 612`,
      ogTitle: `Naprawa Suszarek Przemyśl ☎️ 790 258 612`,
      twitterTitle: `Naprawa Suszarek Przemyśl ☎️ 790 258 612`,
    ...
    schema: {
      ...
      imageObject: {
        ...
        "width": 700,
        "height": 700,
        "name": `Naprawa Suszarek Przemyśl ☎️ 790 258 612`,
