  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `🔧 Naprawa RTV i AGD Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGG`,
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        ogTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
        twitterTitle: `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Suszarek do prania Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV-AGD`,
