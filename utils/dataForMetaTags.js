  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Naprawa RTV i AGD ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | .${name}`,
        ogTitle: `Naprawa RTV i AGD ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | .${name}`,
        twitterTitle: `Naprawa RTV i AGD ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | .${name}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Naprawa RTV i AGD ✔️ Przemyśl ☎️ ${formattedPhoneNumber} | .${name}`,
