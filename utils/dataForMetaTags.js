  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        ogTitle: `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
        twitterTitle: `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis sprzętu RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${shortName}`,
