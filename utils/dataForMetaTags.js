  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        ogTitle: `Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        twitterTitle: `Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
    ...
    kontakt: {
      metaTags: {
        title: `Kontakt ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.kontakt,
          "inLanguage": "pl-PL",
          "name": `Kontakt ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
          "isPartOf": { "@type": "WebSite", "@id": appUrls.home + "#website" },
          "datePublished": datePublished,
          "dateModified": dateModified,
    ...
    naprawa_pralek: {
      metaTags: {
        title: `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        ogTitle: `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        twitterTitle: `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Pralek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | ${serwis.name}`,
        ogTitle: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | ${serwis.name}`,
        twitterTitle: `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | ${serwis.name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Suszarek do prania Przemyśl ☎️ 790 258 612 | ${serwis.name}`,
    ...
    naprawa_zmywarek: {
      metaTags: {
        title: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        ogTitle: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        twitterTitle: `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": "520",
          "height": "520",
          "name": `Naprawa Zmywarek Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
    ...
    naprawa_ekspresow: {
      metaTags: {
        title: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        ogTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        twitterTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
    ...
    naprawa_telewizorow: {
      metaTags: {
        title: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        ogTitle: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
        twitterTitle: `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Telewizorów Przemyśl ☎️ ${formattedPhoneNumber} | ${serwis.name}`,
