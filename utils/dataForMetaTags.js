  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis ✔️ Naprawa sprzętu RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
        ogTitle: `Serwis ✔️ Naprawa sprzętu RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
        twitterTitle: `Serwis ✔️ Naprawa sprzętu RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis ✔️ Naprawa sprzętu RTV i AGD w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
    ...
    kontakt: {
      metaTags: {
        title: `Kontakt ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.kontakt,
          "inLanguage": "pl-PL",
          "name": `Kontakt ☎️ ${formattedPhoneNumber} | ${shortName}`,
          "isPartOf": { "@type": "WebSite", "@id": appUrls.home + "#website" },
          "datePublished": datePublished,
          "dateModified": dateModified,
    ...
    naprawa_pralek: {
      metaTags: {
        title: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
        ogTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
        twitterTitle: `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa Pralek w Przemyślu ☎️ ${formattedPhoneNumber} | ${shortName}`,
