  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
        ogTitle: Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
        twitterTitle: `Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
      ...
      schema: {
        ...
        webpage: {
          ...
          "url": appUrls.home,
          "inLanguage": "pl-PL",
          "name": `Serwis RTV i AGD ✔️ Naprawa Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
    ...
    naprawa_suszarek: {
      metaTags: {
        title: `Naprawa suszarek Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
        ogTitle: `Naprawa suszarek Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
        twitterTitle: `Naprawa suszarek Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          "width": 700,
          "height": 700,
          "name": `Naprawa suszarek Przemyśl ☎️ ${formattedPhoneNumber} | Serwis RTV i AGD`,
