...
const DishwasherServiceMetaTags = () => (
  <Head>
    ...
    <meta
      name="description"
      content="Profesjonalna naprawa zmywarek w Przemyślu. Oferuję szybką pomoc i fachową obsługę, aby Twoja zmywarka działała jak nowa. Używam nowoczesnych technologii i oryginalnych części zamiennych, aby zapewnić długotrwałe i niezawodne naprawy. Skontaktuj się ze mną już dziś, aby skorzystać z moich usług i cieszyć się bezproblemowym działaniem swojej zmywarki."
    />
    ...
    <meta name="twitter:description" content="Profesjonalna naprawa zmywarek w Przemyślu. Oferuję szybką pomoc i fachową obsługę, aby Twoja zmywarka działała jak nowa. Używam nowoczesnych technologii i oryginalnych części zamiennych, aby zapewnić długotrwałe i niezawodne naprawy. Skontaktuj się ze mną już dziś, aby skorzystać z moich usług i cieszyć się bezproblemowym działaniem swojej zmywarki." />
    ...
    <script type="application/ld+json">
      {JSON.stringify({
        ...
        "priceRange": "$$$",
        "description": "Profesjonalna naprawa zmywarek w Przemyślu. Oferuję szybką pomoc i fachową obsługę, aby Twoja zmywarka działała jak nowa. Używam nowoczesnych technologii i oryginalnych części zamiennych, aby zapewnić długotrwałe i niezawodne naprawy. Skontaktuj się ze mną już dziś, aby skorzystać z moich usług i cieszyć się bezproblemowym działaniem swojej zmywarki.",
        "offers": [
          {
            "@type": "Offer",
            "itemOffered": {
