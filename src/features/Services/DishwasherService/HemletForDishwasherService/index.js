...
const HemletForDishwasherService = () => (
  <Helmet>
    <title>Naprawa zmywarek | ✔️ Serwis RTV AGD w Przemyślu</title>
    <meta
      name="description"
    ...
    <meta
      property="og:title"
      content="Naprawa zmywarek | Serwis RTV AGD w Przemyślu"
    />
    <meta
...
export default HemletForDishwasherService;