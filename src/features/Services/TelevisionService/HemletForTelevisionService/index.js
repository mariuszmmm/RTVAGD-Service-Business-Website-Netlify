...
const HemletForTelevisionService = () => (
  <Helmet>
    <title>Naprawa telewizorów | ✔️ Serwis RTV AGD w Przemyślu</title>
    <meta
      name="description"
    ...
    <meta
      property="og:title"
      content="Naprawa telewizorów | Serwis RTV AGD w Przemyślu"
    />
    <meta
...
export default HemletForTelevisionService;